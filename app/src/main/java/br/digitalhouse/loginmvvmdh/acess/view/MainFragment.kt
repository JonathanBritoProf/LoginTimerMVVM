package br.digitalhouse.loginmvvmdh.acess.view
...
import br.digitalhouse.loginmvvmdh.acess.Interfaces.LoginResultInterface
import br.digitalhouse.loginmvvmdh.R
import br.digitalhouse.loginmvvmdh.acess.viewmodel.LoginViewModel
...
class MainFragment : Fragment(R.layout.fragment_main), LoginResultInterface {
    ...
    private fun changeScreen(){
        findNavController().navigate(R.id.action_mainFragment_to_timerActivity)
    }
